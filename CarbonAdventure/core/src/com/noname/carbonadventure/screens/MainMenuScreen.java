...
public class MainMenuScreen implements Screen {
    ...
    public MainMenuScreen (CarbonAdventure game) {
        ...
        viewport = new StretchViewport(CarbonAdventure.WIDTH, CarbonAdventure.HEIGHT, camera);
        viewport.apply();
        camera.position.set(CarbonAdventure.WIDTH / 2, CarbonAdventure.HEIGHT / 2, 0);
    }
    ...
    public void render(float delta){
        ...
        game.batch.begin();
        float logoX = CarbonAdventure.WIDTH / 2 - logoTexture.getWidth() / 2;
        float logoY = CarbonAdventure.HEIGHT - logoTexture.getHeight() - 10; // 50 is an arbitrary padding from the top
