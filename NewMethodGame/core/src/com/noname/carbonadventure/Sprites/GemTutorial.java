...
public class GemTutorial extends InteractiveTileObject {
    private static int gemCount = 0; // Static variable to keep track of total gems

    public GemTutorial(PlayScreen screen, Rectangle bounds) {
        super(screen, bounds);
    ...
    public void OnBodyHit() {
        ...
        if (gemCount == 0) {
            BarricadeTutorial.destroyAll(); // Destroy all Barricade objects
